    ...
    <div className="relative flex h-full w-full flex-col px-28">
      ...
      <div className="mt-4 flex h-[80%] max-h-[600px] w-full justify-evenly rounded-xl bg-neutral-800/40 p-6 backdrop-blur-md">
        <div className="relative flex h-full w-[20%] flex-col justify-between rounded-xl">
          <div className="flex h-[12%] w-full flex-col items-center justify-evenly">
            <div className="flex w-[50%] items-center justify-evenly">
              <select
                ...
                value={selectedField}
                className="foucs:border-0 relative flex h-max w-max rounded-lg bg-neutral-700 px-2 py-1 text-center text-xs font-bold text-white hover:cursor-pointer focus:outline-blue-400"
              >
                category
            ...
            <div className="flex w-full items-center justify-center">
              <div className="flex w-24 items-center justify-evenly">
                <p className="rounded-xl bg-neutral-700 px-2 py-1 text-xs text-white">
                  {dateInput.get("year")}
                </p>
          ...
          <div className="flex h-[55%] w-full items-center justify-center rounded-xl bg-neutral-700 p-4 shadow-lg">
            <DoughnutChart
              data={
                selectedField === "todo"
                  ? todosDoughnutData
            ...
            {selectedField === "mood" ? (
              <div className="relative h-full w-[46%] flex-col rounded-xl bg-neutral-400/40 p-4 shadow-lg">
                ...
                <p className="flex flex-col text-sm text-white">
                  ...
                  <span>you can ease your minds and help you feel better.</span>
                </p>
