    ...
    <Layout userData={userData}>
      ...
      <main className="relative flex h-[90%] max-h-[900px] min-h-[500px] w-full max-w-[1700px] flex-col items-center px-4 lg:min-h-[700px] lg:px-28">
        ...
        <motion.div
          ...
          className="mt-4 flex h-[85%] w-full rounded-xl bg-neutral-300/40 backdrop-blur-lg transition-colors dark:bg-neutral-800/40 lg:h-[80%]"
        >
          <div
            className={`scrollable flex h-full w-full flex-col items-start overflow-y-scroll p-6 lg:flex-row lg:justify-evenly lg:overflow-visible ${
          ...
          >
            ...
            <div className="flex h-max w-full flex-col-reverse justify-between lg:h-full lg:w-[75%] lg:flex-col lg:px-4">
              <div className="scrollable stat-item flex h-[300px] w-full justify-start overflow-x-scroll rounded-xl bg-neutral-300/40 shadow-lg transition-colors dark:bg-neutral-700/80 lg:h-[60%] xl:items-center xl:justify-center">
                <YearChart
                  data={
                    selectedField === "todo"
                      ? todosData.length
