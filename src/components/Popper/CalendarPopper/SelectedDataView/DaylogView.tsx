      ...
      <div className="flex h-full w-full flex-col items-center justify-evenly">
        ...
        <LexicalComposer initialConfig={initialConfig}>
          <RichTextPlugin
            ...
            contentEditable={
              <ContentEditable className="editor-input flex h-[90%] w-[90%] flex-col overflow-y-scroll rounded-lg border-2 border-white bg-neutral-700 p-4 text-sm text-white" />
            }
          />
          <ListPlugin />
